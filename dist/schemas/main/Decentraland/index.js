...
exports.DecentralandSchema = {
    ...
    formatter: (asset) => __awaiter(this, void 0, void 0, function* () {
        const districtResponse = yield axios_1.default.get(`https://api.land.decentraland.org/api/districts`);
        const districts = districtResponse.data.data;
        const assetResponse = yield axios_1.default.get(`https://api.land.decentraland.org/api/parcels?nw=${asset.x},${asset.y}&se=${asset.x},${asset.y}`);
    ...
    events: {
        transfer: [{
                ...
                assetFromInputs: (inputs, web3) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    const res = yield typed_promisify_1.promisify(contract.decodeTokenId.call)(inputs.assetId);
                    return {
                        x: res[0].toString(),
                        y: res[1].toString(),
                    };
